...
Rails.application.configure do
  ...
  config.assume_ssl = ActiveModel::Type::Boolean.new.cast(
    ENV.fetch("ASSUME_SSL", ENV.fetch("FORCE_SSL", "true"))
  )
  ...
  # Deliver mail via Resend. Set RESEND_API_KEY (or credentials.resend_api_key) and
  # a verified-domain MAIL_FROM in the production environment. See config/initializers/resend.rb.
