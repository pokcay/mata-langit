...
You are entering plan mode to plan and then build milestone 3 of **Master Rental**.
...
- Read previous milestone logs in `@_build_plan/12-master-rental/milestones/` to understand what has already been built for this feature.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/12-master-rental/milestones/3-history-list-management/milestone-log.md`) summarizing:
...
5. After writing `milestone-log.md`, update `_build_plan/INDEX.md`:
   ...
   - Append a line to the Changelog section: `- **{YYYY-MM-DD}** — Feature 12 (Master Rental), Milestone 3 complete: {one-line summary of what was delivered}. Feature 12 complete.`
