...
You are entering plan mode to plan and then build milestone 1 of **Pivot**.
...
- This is milestone 1; there are no prior milestone logs for this feature.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/04-pivot/milestones/1-core-pivot-engine/milestone-log.md`) summarising:
...
5. After writing `milestone-log.md`, update `_build_plan/INDEX.md`:
   - Change feature 4's Status to `🔄 In Progress (M1/3)`
   - Append a line to the Changelog: `- **{YYYY-MM-DD}** — Feature 4 (Pivot), Milestone 1 complete: {one-line summary}`
