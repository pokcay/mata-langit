...
You are entering plan mode to plan and then build milestone 2 of **Pivot**.
...
- Read `@_build_plan/04-pivot/milestones/1-core-pivot-engine/milestone-log.md` to understand what was built in milestone 1 and any decisions made there.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/04-pivot/milestones/2-filters-and-url-config/milestone-log.md`) summarising:
...
5. After writing `milestone-log.md`, update `_build_plan/INDEX.md`:
   - Change feature 4's Status to `🔄 In Progress (M2/3)`
   - Append a line to the Changelog: `- **{YYYY-MM-DD}** — Feature 4 (Pivot), Milestone 2 complete: {one-line summary}`
