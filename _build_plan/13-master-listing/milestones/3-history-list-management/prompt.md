...
You are entering plan mode to plan and then build milestone 3 of **Master Listing**.
...
- Read previous milestone logs in `@_build_plan/13-master-listing/milestones/` to understand what has already been built for this feature.
- The just-shipped **Master Rental** feature (its paginated/filterable/sortable history table + mobile filter/sort bottom sheets) is the closest reference for this milestone.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/13-master-listing/milestones/3-history-list-management/milestone-log.md`) summarizing:
...
5. After writing `milestone-log.md`, update `_build_plan/INDEX.md`:
   - Change this feature's Status to `✅ Complete` (this is the last milestone)
   - Append a line to the Changelog section: `- **{YYYY-MM-DD}** — Feature 13 (Master Listing), Milestone 3 complete: {one-line summary of what was delivered}. Feature 13 complete.`
