...
You are entering plan mode to plan and then build milestone 3 of **Trans Sell Out Account**.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/07-trans-sellout-account/milestones/3-list-management/milestone-log.md`) summarizing:
...
5. After writing `milestone-log.md`, update `_build_plan/INDEX.md`:
   ...
   - Append a line to the Changelog section: `- **{YYYY-MM-DD}** — Feature 7 (Trans Sell Out Account), Milestone 3 complete: {one-line summary of what was delivered}`
